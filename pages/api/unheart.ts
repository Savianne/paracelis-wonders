  ...
  res: NextApiResponse
    ...
    try {
        ...
        try {
            ...
            const affectedRows = (await connection.query("DELETE FROM heartreact WHERE userEmail = ? AND destinationUID = ?", [userEmail, placeUID]) as OkPacketParams[])[0].affectedRows;
